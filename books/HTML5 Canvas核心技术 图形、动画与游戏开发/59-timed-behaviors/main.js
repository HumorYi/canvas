...
const thrustersWidth = thrustersCanvas.width
const thrustersHeight = thrustersCanvas.height
...
const paintArrow = context => {
  const x = thrustersWidth / 2 - ARROW_MARGIN / 2
  const y = thrustersHeight - ARROW_MARGIN / 2

  context.beginPath()

  context.moveTo(x, ARROW_MARGIN / 2)

  context.lineTo(x, thrustersHeight - ARROW_MARGIN)

  context.quadraticCurveTo(x, y, thrustersWidth / 2 - ARROW_MARGIN, y)

  context.lineTo(ARROW_MARGIN, thrustersHeight / 2 + ARROW_MARGIN / 2)

  context.quadraticCurveTo(ARROW_MARGIN - 3, thrustersHeight / 2, ARROW_MARGIN, thrustersHeight / 2 - ARROW_MARGIN / 2)

  context.lineTo(thrustersWidth / 2 - ARROW_MARGIN, ARROW_MARGIN / 2)

  context.quadraticCurveTo(thrustersWidth / 2 - ARROW_MARGIN, ARROW_MARGIN / 2, x, ARROW_MARGIN / 2)
  context.fill()
  context.stroke()
}
...
const paintRightArrow = context => {
  ...
  thrustersContext.translate(thrustersWidth, 0)
...
const paintThrusters = () => {
  ...
  thrustersContext.clearRect(0, 0, thrustersWidth, thrustersHeight)
...
thrustersCanvas.onmousedown = e => {
  ...
  arrow = x - rect.left > thrustersWidth / 2 ? RIGHT :LEFT
  pushTimer.isRunning() ? pushTimer.stop() : pushTimer.start()
}
